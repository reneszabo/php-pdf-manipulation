  ...
  <tr>
    ...
    <td class="order-data">
      <table>
        ...
        <tr class="order-date">
          <th>Order Date:</th>
          <td><?php echo date('F j, Y',$invoice['date']); ?></td>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <tr class="no-borders">
    <td class="no-borders" colspan="2">
      <div class="customer-notes">
        <p><b>Notes:</b></p>
        <p>
          <u>Status:</u> <?php echo $invoice['status']; ?>
        </p>
      </div>
    </td>
    <td class="no-borders" colspan="2">
      <table class="totals">
        ...
        <tr class="cart_subtotal">
          ...
          <td class="price"><span class="totals-price"><span class="amount">$ <?php echo number_format($invoice['shipping'],2); ?></span></span></td>
        </tr>
        <tr class="cart_subtotal">
          <td class="no-borders"></td>
          <th class="description">Subtotal</th>
          <td class="price"><span class="totals-price"><span class="amount">$ <?php echo number_format($invoice['subtotal'],2); ?></span></span></td>
        </tr>
        <tr class="cart_subtotal">
          <td class="no-borders"></td>
          <th class="description">Tax</th>
          <td class="price"><span class="totals-price"><span class="amount">$ <?php echo number_format($invoice['tax'],2); ?></span></span></td>
        </tr>
        <tr class="order_total">
          <td class="no-borders"></td>
          <th class="description">Total</th>
          <td class="price"><span class="totals-price"><span class="amount">$ <?php echo number_format($invoice['total'],2); ?></span></span></td>
        </tr>
        </tfoot>
      </table>
    </td>
